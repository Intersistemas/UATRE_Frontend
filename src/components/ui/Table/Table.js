...
const rowStyle2 = (row, cell) => { //esta pensado como funcion para que cada componente envie su estilo, pensando en colores segun registros de una columna
  const rowStyle = { 
              ...
              <div>
                ...
                <div className={classes.tabla}>
                  <BootstrapTable
                    ...
                    filter = {props.filter}
                    noDataIndication= {props.noDataIndication ?? "No existen datos para mostrar"}
                    rowEvents = {rowEvents}
