...
//                   detalles:
//                     (record.tipoPregunta === "TX" && record.textoLibre)
...
//                 setList((prev) => ({
//                   ...prev,
//                   data: [...prev.data, nuevaPregunta], // Se mantiene la lista previa mas la nueva pregunta
        ...
        onClose={(confirm) => {
          ...
          switch (list.selection.request) {
            ...
            case "A":
              ...
              // // Crear encuesta respuestas
            
              //   query.action = "CreateEncuestaRespuestas";
            
              //   // params: { id: record.seccionalId },
              //   query.config.body = {
                    
              //       cuil: Usuario.cuit, // Usamos el cuil del usuario autenticado
              //       encuestaId: record.encuestaId, // ID de la encuesta
              //       respuestas: [
              //         {
              //           encuestaPreguntaId: record.id,
              //           valor: record.enunciado
              //         }
              //       ]
              //     }
