...
const AfiliadosEstadosEmpresasSeccionales = ({ onClose = onCloseDef }) => {
			...
			case "GetData": {
				return {
					config: {
						...
						endpoint: `/Afiliados/EmpresasSeccionalesAfiliadosEstados`,
						method: "GET",
					},
				};
			}
	...
	useEffect(() => {
		...
		query.onFinally = async () => {
			...
			downloadjs(
				...
				"EstadosSolicitudesEmpresasSeccionales.csv",
				"text/csv"
			);
		};
		pushQuery(query);
...
export default AfiliadosEstadosEmpresasSeccionales;
