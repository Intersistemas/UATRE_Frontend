...
const TrabajadoresEstadosEmpresasSeccionales = ({ onClose = onCloseDef }) => {
			...
			case "GetData": {
				return {
					config: {
						...
						endpoint: `/Afiliados/DDJJ12MesesEmpresasSeccionalesAfiliadosEstados`,
						method: "GET",
					},
				};
			}
	...
	useEffect(() => {
		...
		query.onFinally = async () => {
			...
			downloadjs(
				...
				"TrabajadoresSolicitudesEmpresasSeccionales.csv",
				"text/csv"
			);
		};
		setCSV((o) => ({ ...o, ...changes }));
...
export default TrabajadoresEstadosEmpresasSeccionales;
