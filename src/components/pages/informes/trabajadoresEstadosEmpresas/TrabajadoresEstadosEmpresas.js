...
const TrabajadoresEstadosEmpresas = ({ onClose = onCloseDef }) => {
			...
			case "GetData": {
				return {
					config: {
						...
						endpoint: `/Afiliados/DDJJ12MesesEmpresasAfiliadosEstados`,
						method: "GET",
					},
				};
			}
	...
	const [csv, setCSV] = useState({
		...
		filtros: {},
		params: {},
		data: [["Período", "CUIT empresa", "Razón social empresa", "Estado", "Cantidad"]],
		error: null,
	});
	...
	useEffect(() => {
		...
		query.onFinally = async () => {
			...
			downloadjs(
				...
				"TrabajadoresSolicitudesEmpresas.csv",
				"text/csv"
			);
		};
		setCSV((o) => ({ ...o, ...changes }));
					...
					<Grid gap="20px" justify="end">
						<Grid width="250px">
							<Button
								...
								loading={!!csv.loading}
								onClick={() => onCSV()}
								tarea="Informes_DDJJ_TrabajadoresDeclaradosEmpresa_CSV"
							>
								GENERA ARCHIVO CSV
							</Button>
						</Grid>
...
export default TrabajadoresEstadosEmpresas;
