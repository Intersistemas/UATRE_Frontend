				...
				<Grid col full gap="15px">
					...
					<Grid width gap="inherit">
						<Grid width="25%">
							<InputMaterial
								label="C.P. localidad"
								value={list.params.refLocalidadCP}
								onChange={(refLocalidadCP) => {
									const params = { ...list.params };
									if (refLocalidadCP) params.refLocalidadCP = refLocalidadCP;
									else delete params.refLocalidadCP;
									setList((o) => ({
										...o,
										loading: "Cargando...",
										params,
						...
						<Grid width>
							<InputMaterial
								...
								value={list.params.refLocalidadNombre}
								onChange={(refLocalidadNombre) => {
									const params = { ...list.params };
									if (refLocalidadNombre) params.refLocalidadNombre = refLocalidadNombre;
									else delete params.refLocalidadNombre;
									setList((o) => ({
										...o,
										loading: "Cargando...",
										params,
