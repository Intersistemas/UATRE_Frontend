...
import useGestionOS, { onLoadSelectKeepOrFirst } from "./useAuditoriaProc";
...
import ExcelDatos from "../../gestionOS/ExcelDatos";

const AuditoriaProcHandler = () => {
...
export default AuditoriaProcHandler;