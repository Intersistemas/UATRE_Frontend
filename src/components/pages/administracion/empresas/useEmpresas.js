      ...
      <EmpresasForm
                ...
                pushQuery({
                  ...
                  onOk: async (record) => {
                    ...
                    if (record.deletedDate) {
                      params.request = "R";
                      params.action = `Reactiva Empresa ${Formato.Cuit(
                        record.cuit
                      )}`;
                    } else {
                      params.request = "M";
                      params.action = `Modifica Empresa ${Formato.Cuit(
                        record.cuit
                      )}`;
                    }
        ...
        onClose={(confirm) => {
          ...
          if (["A", "M"].includes(list.selection.request)) {
            ...
            else if (!matchIsValidTel(record.telefono))
              errors.telefono = "Dato incorrecto";
