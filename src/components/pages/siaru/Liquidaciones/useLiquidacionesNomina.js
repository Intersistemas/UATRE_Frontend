...
import LiquidacionesNominaTable from "../Liquidaciones/LiquidacionesNominaTable";
import LiquidacionesNominaForm from "../Liquidaciones/LiquidacionesNominaForm";
      ...
      <LiquidacionesNominaForm
        ...
        onClose={(confirm) => {
          ...
          if (list.selection.request === "B") {
            ...
            if (!record.cuil) errors.cuil = "Dato requerido";
            else if (!ValidarCUIT(record.cuil)) errors.cuil = "Dato inválido";
