...
import useLiquidaciones from "../Liquidaciones/useLiquidaciones";
...
const LiquidacionesHandler = () => {
  ...
  if (despliegaPDF) {
    liquidacionPDFRender = (
      <FormaPagoPrint
        liquidacionCabecera={despliegaPDF}
  ...
  const acciones = useMemo(
    () => [
      ...(!route.pathname.includes("Establecimientos")
        ? [
            new Action({
              name: `Establecimientos de ${empresa.cuit} - ${empresa.id} - ${empresa.razonSocial}`,
